...
def main():
	...
	output_line_graph2(
		adir,
		[datetime.fromisoformat(date).astimezone(timezone.utc) for date in atb_users],
	...
	output_line_graph2(
		adir,
		[datetime.fromisoformat(date).astimezone(timezone.utc) for date in atb_locales],
	...
	output_line_graph2(
		adir,
		[datetime.fromisoformat(date).astimezone(timezone.utc) for date in atb_oss],
	...
	labels = [datetime.fromisoformat(date).astimezone(timezone.utc) for date in atb_addons]
